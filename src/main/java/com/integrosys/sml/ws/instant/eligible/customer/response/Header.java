...
public class Header  extends com.integrosys.sml.ws.common.CommonWSResponseHeader  implements java.io.Serializable {
    public Header() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://response.customer.eligible.instant.ws.sml.integrosys.com", "Header"));
    }
