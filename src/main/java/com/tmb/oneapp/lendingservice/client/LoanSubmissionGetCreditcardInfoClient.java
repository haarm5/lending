...
public class LoanSubmissionGetCreditcardInfoClient {
    ...
    private com.tmb.common.model.legacy.rsl.ws.creditcard.request.Header setHeader() {
        com.tmb.common.model.legacy.rsl.ws.creditcard.request.Header header = new com.tmb.common.model.legacy.rsl.ws.creditcard.request.Header();
    ...
    private com.tmb.common.model.legacy.rsl.ws.creditcard.request.Body setBody(long caId) {
        com.tmb.common.model.legacy.rsl.ws.creditcard.request.Body body = new com.tmb.common.model.legacy.rsl.ws.creditcard.request.Body();
        body.setCaID(caId);
        return body;
    }
}
