...
public class FopConfig implements ResourceLoaderAware {
    ...
    private void setupFopFiles() throws IOException {
        String[] files = new String[]{"01_210615152223_abc_00110.JPG","tmblogo.png", "InstantLoanNCBConsentTH.xsl", "DBOzoneX.ttf", "DBOzoneX-Bold.ttf", "DBOzoneX-Italic.ttf", "fop-config.xml"};
        new File("./fop").mkdir();
