...
public class InstantLoanCreateApplicationControllerTest {

    ObjectMapper mapper;
    InstantLoanCreateApplicationController instantLoanCreateApplicationController;
    @Mock
    ...
    void setUp() throws JsonProcessingException {
        ...
        instantLoanCreateApplicationController =  new InstantLoanCreateApplicationController(createLoanApplicationService);
    ...
    void createInstantLoanApplicationForCC(){
        ...
        when(createLoanApplicationService.createInstantLoanApplication(ccRequest)).thenReturn(expectedResponse);

        ResponseEntity<TmbOneServiceResponse<InstantLoanCreationResponse>>  actualResult = instantLoanCreateApplicationController.createInstantLoanApplication(ccRequest);
        assertEquals(HttpStatus.OK, actualResult.getStatusCode());
        assertEquals(expectedResponse.getRequestId(), actualResult.getBody().getData().getRequestId());

        expectedResponse.setError("exception");
    ...
    void createInstantLoanApplicationForFlashCard(){
        ...
        when(createLoanApplicationService.createInstantLoanApplication(any())).thenReturn(expectedResponse);

        ResponseEntity<TmbOneServiceResponse<InstantLoanCreationResponse>>  actualResult = instantLoanCreateApplicationController.createInstantLoanApplication(flashCardRequest);
        assertEquals(HttpStatus.OK, actualResult.getStatusCode());
        assertEquals(expectedResponse.getRequestId(), actualResult.getBody().getData().getRequestId());
