...
public class RslControllerTest {
    ...
    @Test
    public void updateIncompleteDocApplication_Success() throws TMBCommonException, JsonProcessingException, ServiceException {
        ...
        ResponseEntity<TmbOneServiceResponse<ResponseDocApplication>> responseEntity = rslController.updateIncompleteDocApplication(correlationId, crmId, request);
    ...
    @Test
    public void updateIncompleteDocApplication_Fail() {
        String correlationId = "correlationId";
        String crmId = "001100000000000000000018593707";
        DocApplication request = new DocApplication();
        request.setCaId(1L);
        ...
        TMBCommonException exception = assertThrows(TMBCommonException.class, () -> {
            doThrow(new ServiceException("error")).when(rslService).updateIncompleteDocApplication(any());
            rslController.updateIncompleteDocApplication(correlationId, crmId, request);
        });
    ...
    @Test
    public void updateIncompleteDocApplication_TMBCommonExceptionFail() {
        String correlationId = "correlationId";
        String crmId = "001100000000000000000018593707";
        DocApplication request = new DocApplication();
        request.setCaId(1L);
        ...
        TMBCommonException exception = assertThrows(TMBCommonException.class, () -> {
            doThrow(new TMBCommonException(ResponseCode.RSL_CONNECTION_ERROR.getCode(), ResponseCode.RSL_CONNECTION_ERROR.getMessage(), ResponseCode.RSL_CONNECTION_ERROR.getService(), HttpStatus.INTERNAL_SERVER_ERROR, null))
                    .when(rslService).updateIncompleteDocApplication(any());
            rslController.updateIncompleteDocApplication(correlationId, crmId, request);
        });
