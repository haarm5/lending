...
public class InstantLoanCreateApplicationServiceTest {
    ...
    void setUp() throws JsonProcessingException {
        ...
        createApplicationService =  new InstantLoanCreateApplicationService(mapper,Client, imageGeneratorService);
    ...
    void InstantLoanCreationForRemoteException() throws RemoteException, ServiceException, JsonProcessingException {
        ...
        InstantLoanCreationResponse actualresponse = createApplicationService.createInstantLoanApplication(ccRequest);
        assertEquals("exception",actualresponse.getError());
